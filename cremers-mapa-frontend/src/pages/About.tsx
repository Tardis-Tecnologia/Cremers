...
const About: React.FC = () => {
  return (
    <Box component="main" className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
      <Sidebar />
      <Box className="flex-1 flex flex-col items-center px-2 md:px-4 py-4 md:py-8 mt-16 md:mt-0">
        <section className="bg-white rounded-2xl shadow-lg p-4 md:p-8 w-full max-w-6xl border border-gray-200">
          <header>
            <Typography variant="h4" component="h1" fontWeight={600} color="#40626a" gutterBottom style={{ textAlign: 'left' }}>
              Apresentação
            </Typography>
          </header>
          <Typography variant="body2" color="text.secondary" paragraph style={{ textAlign: 'justify', marginBottom: 16 }}>
          ...
          <Typography variant="body2" color="text.secondary" paragraph style={{ textAlign: 'justify', marginBottom: 16 }}>
            A disponibilização dos dados dinamicamente atualizados levará, consequentemente, a perene produção de conhecimento sobre os diferentes fenômenos que atingem a população de médicos. Com este trabalho o CFM espera atingir uma de suas principais missões, que diz respeito a promoção do bem-estar da sociedade Brasileira.
          </Typography>
          <Typography variant="h6" component="p" align="center" fontWeight={700} color="#222" style={{ marginTop: 24 }}>
